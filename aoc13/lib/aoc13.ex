defmodule Aoc13 do
  ...
  def parse(text) do
    ...
    # second line is available buses
    lines = String.split(text, "\n")
    start = Enum.at(lines, 0) |> String.to_integer()
    buses = Enum.at(lines, 1)
    {start, buses}
  end
...
defmodule CRT do
  ...
  Each subsequent iteration finds a solution that includes the next equation.
  """
  def inner(remainders, moduli, step, result)
